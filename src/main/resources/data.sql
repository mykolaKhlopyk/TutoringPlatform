INSERT INTO users (email, username, password, name, surname, phone, sex)
VALUES
    ('john.doe@example.com', 'johndoe', '$2a$10$5ZFeVx3zNDL.Of5SneubhO2VzmOeQLUXfVtHQOZTPL3KCSzDImHQq', 'John', 'Doe', '555-1234', 'MALE'),
    ('jane.smith@example.com', 'janesmith', '$2a$10$5ZFeVx3zNDL.Of5SneubhO2VzmOeQLUXfVtHQOZTPL3KCSzDImHQq', 'Jane', 'Smith', '555-5678', 'FEMALE');
